#!/usr/bin/python3
""" TLG NDE Python | LAncheta | Creating Output Files from Data Sets """
...
def main():
    ...
    with open("csv_users.txt", "r") as csvfile:
        i = 0 # counter to create unique file names
        for row in csv.reader(csvfile): # loop across our open file line by line
            ...
            with open(filename, "w") as rcfile:
                ...
                # out to the open rcfile (open in write mode)
